 ...
 * @ Description：重写FrameLayout,自定义FrameLayout样式
 *
...
public class FrameLayoutM extends RelativeLayout {
    ...
    public FrameLayoutM(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }
    public FrameLayoutM(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public FrameLayoutM(Context context) {
        this(context, null);
    }
    private void init() {
